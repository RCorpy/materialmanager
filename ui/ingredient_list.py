...
class IngredientListFrame(tk.LabelFrame):
    ...
    def refresh(self):
        ...
        for mid, mname, identifier, price in database.get_materials():
            if filter_text.lower() in mname.lower():
                ...
                self.materials.append((mid, mname))
    ...
    def on_select(self, event=None):
        ...
        if not sel:
            return
        index = sel[0]
        ing_id, ing_name = self.materials[index]
        self.selected_ingredient_id = ing_id
        self.selected_ingredient_name = ing_name

        # Load this ingredient into add_material frame if exists
    ...
    def add_ingredient(self):
        ...
        try:
            ...
            messagebox.showerror("Error", "Introduce un número válido para la cantidad.")
            return
